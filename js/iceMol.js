/* 
mol library, initially contained mol files from https://github.com/mbuliga/quinegraphs/blob/master/js/iceMol.js
...
// chemSKI examples
  ...
  case "SA":
  var mol = "S 1 1 2^A 2 3 4";
  break;

  case "AS":
  var mol = "A 1 2 3^S 3 4 5";
  break;
  ...
  case "SS1":
  var mol = "S 1 1 2^S 2 3 4";
  break;

  case "SS2":
  var mol = "S 1a 1 2^S 2 3 4";
  break;
  ...
  case "SAA":
  var mol = "S 1 1 2^A 2 3 4^A 4 5 6";
  break;

  case "KAB":
  var mol = "K 1^A 1 2 3^A 3 4 5";
  break;

  case "SABC":
  var mol = "S 1 1 2^A 2 3 4^A 4 5 6^A 6 7 8";
  break;

  case "SKKI":
  var mol = "S 1 1 2^A 2 6 3^A 3 7 4^A 4 8 5^K 6^K 7^I 8";
  break;

  case "SIISII":
  var mol = "S 1 1 2^A 2 3 4^I 3^A 4 5 6^I 5^A 6 8 7^A 9 10 8^I 10^A 11 12 9^I 12^S 0 0 11";
  break;
  ...
  case "SKIREC":
  var mol = "A 2 3 1^A 4 5 3^I 5^A 6 7 4^S 6a 6a 6^I 7^A 8 9 2^S 8a 8a 8^A 10 a 9^I a^K 10^A 1 1p 0^A 2p 3p 1p^A 4p 5p 3p^I 5p^A 6p 7p 4p^S 6ap 6ap 6p^I 7p^A 8p 9p 2p^S 8ap 8ap 8p^A 10p ap 9p^I ap^K 10p";
  break;
