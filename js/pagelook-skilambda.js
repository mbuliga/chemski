...
forked from https://github.com/mbuliga/quinegraphs/blob/master/js/pagelook-vs.js

uses toggle between chemSKI and chemSKI+lambda
...
//    graphRewriteSystems = ["T","COMB","IC","CHEMLAMBDABARE","CHEMLAMBDAEND","CHEMSKI"];
    ...
    graphRewriteSystems = ["T","COMB","IC","CHEMLAMBDABARE","CHEMLAMBDAEND","CHEMSKI+LAMBDA"];
  }
  transformList = [];
...
var ButtonLambda = [
  ...
  {"Id":"buttonAge", "Class":"image2", "Visibility":"visible", "Onclick": function () {setOlder();}, "Text":"change"}, 
  {"Id":"whichChem", "Class":"image2", "Visibility":"visible", "Onclick": function () {setChemPlus();}, "Text":"change"},
...
//  {"Id":"buttonAge", "Class":"image2", "Visibility":"visible", "Onclick": function () {setOlder();}, "Text":"change"}, 
  {"Id":"whichChem2", "Class":"image2", "Visibility":"visible", "Onclick": function () {setChemPlus();}, "Text":"change"},
//  {"Id":"whichMetabo", "Class":"image2", "Visibility":"visible", "Onclick": function () {setMetabo();}, "Text":"change"},
//  {"Id":"buttonShot", "Class":"image2", "Visibility":"visible", "Onclick": function () {screenShot();}, "Text":"photo"}  
];
...
var whatsInThere = document.getElementById('inputlambda').value;
  if (isChemlambda == 1) {
    isChemlambda = 0;
    chemistryChoice();
    document.getElementById("chemtext").innerHTML = "chemSKI+&lambda;";
